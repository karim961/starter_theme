...
$theme_utils->addNavMenus([
    ...
    ->addStyle('googlefonts', "https://fonts.googleapis.com/css?family=Open+Sans:300,400,400i,700,700i")
    ...
    ->addImageSize('logo_thumb', 180, 90, array('center', 'center'))
    ->addImageSize('banner', 1920, 326, array('top', 'center'))
    ->addImageSize('slider_image', 1920, 9280, array('top', 'center'))
    ->add_theme_options();
